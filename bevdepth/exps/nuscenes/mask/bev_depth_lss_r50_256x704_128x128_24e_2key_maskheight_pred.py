...
from bevdepth.exps.nuscenes.base_mask_exp import \
    BEVDepthLightningModelPred as BaseBEVDepthLightningModel
from bevdepth.models.base_bev_depth import MaskHeightBEVDepthPred
...
if __name__ == '__main__':
    run_cli(BEVDepthLightningModel,
            'bev_depth_lss_r50_256x704_128x128_24e_2key_maskheight_pred')